...
<style>
@import
	url("https://fonts.googleapis.com/css?family=Nunito+Sans:400,600,700&display=swap")
	;
...
.receipt dl div, .receipt dl:last-child {
	display: flex;
...
<body>
	TESTING PAGE
	<h1>
		회원 가입 페이지 <span>정보는 제 DB에 저장됩니다.</span>
	</h1>
	...
	<div class="receipt">
		...
		<form action="signupOK" name="signupForm" method="post">
			...
			<div>
				<dl>
					<dt>
						비밀번호<input type="text" required name="password" />
					</dt>
					<dd></dd>
				</dl>
			</div>
			<div>
				<dl>
					<dt>
						메일주소<input type="email" required name="email" minlength="3" />
					</dt>
					<dd></dd>
				</dl>
			</div>
